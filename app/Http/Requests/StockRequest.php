...
class StockRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'quantity_ToPurchase' => 'nullable|integer|min:0',
    ...
    public function messages()
    {
        return [
            ...
            'quantity_ToPurchase.integer' => 'The quantity to purchase field must be an integer.',
            'quantity_ToPurchase.min' => 'The quantity to purchase must be at least 0.',
